...
#include "../Inc/measure_standard.h"

// 测试标准列表
MeasureStandard MeasureStandardList[MEASURE_STANDARD_TOTAL_CNT] = {
...
// 已选择的测试列表
MeasureStandard SelectedMeasureStandardList[MEASURE_STANDARD_TOTAL_CNT];